...
PROVIDERS: dict[str, ProviderProfile] = {
    "native": ProviderProfile(
        ...
        server_import="sceneapi_map.colmap.native.server:app",
    ...
    "pycolmap": ProviderProfile(
        ...
        server_import="sceneapi_map.colmap.pycolmap.server:app",
        backend_from_env=True,
        bundled_lookup=False,
        configure_module="sceneapi_map.colmap.pycolmap.backend",
    ),
    "cli": ProviderProfile(
        ...
        server_import="sceneapi_map.colmap.cli.server:app",
        backend_from_env=False,
        bundled_lookup=False,
        configure_module="sceneapi_map.colmap.cli.backend",
    ),
}
