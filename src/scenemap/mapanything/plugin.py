...
manifest: PluginManifestDict = {
    ...
    "description": (
        ...
        "`map.feed_forward` capability via the sceneio Mapper contract. "
    ...
    "entry_points": ["scenemap.mapanything.plugin:plugin"],
    "providers": [
        {
            ...
            # One portable capability, backed by the sceneio Mapper contract
    ...
    "runtime_modes": {
        ...
        # the wrapper package and then runs `scenemap.mapanything.provisioning`.
        "uv": {
            "source": "git",
